...
CmdLineParser::Option g_options[] =
{
   ...
   // USERINFO CONFIG   
   {SEPARATOR_USERINFO,  '\0', "\0",      CmdLineParser::E_NO_ARG, 0, "USERINFO options - only applicable if --userInfo indicated\r\n"},
   ...
   // ENVVARS CONFIG   
   {SEPARATOR_ENVVARS,  '\0', "\0",      CmdLineParser::E_NO_ARG, 0, "EnvVars options - only applicable if --envVars indicated\r\n"},
   {ENV_SIZE_OPT,'s', "size",    CmdLineParser::E_NO_ARG, 0, "Display the size of the current environment variable list"},
   {ENV_VAL_OPT, 'l', "lookup",  CmdLineParser::E_OPTIONAL_ARG, 0, "Lookup the value for the specified key(s) (multi-value by comma-separated list).  If no key is specified, show all."},
   // GENERAL_OPTIONS
   {SEPARATOR_GENERAL,  '\0', "\0",      CmdLineParser::E_NO_ARG, 0, "General options"},
